...
//    }
    ...
    private void initF3X4L10K(int nTaxa, boolean symmetric) {
        Alignment data = null;
        try {
            data = CodonTestData.getAligL10K(nTaxa);
    ...
    private void initF3X4T128L500() {
        Alignment data = null;
        try {
            data = CodonTestData.getAligL500();
        } catch (XMLParserException e) {
            e.printStackTrace();
        }
