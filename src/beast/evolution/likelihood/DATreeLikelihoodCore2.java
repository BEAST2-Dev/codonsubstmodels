...
// *
// */
//public class DATreeLikelihoodCore2 extends AbstrDATreeLikelihoodCore {
//
...
//     */
//    public DATreeLikelihoodCore2(int nThreads, int nrOfStates, int[][] tipStates, InternalNodeStates internalNodeStates, int categoryCount) {
