...
public abstract class AbstrDATreeLikelihoodCore2 extends AbstrDALikelihoodCore {
    ...
    protected NodesStatesAndTree nodesStates;
     ...
     */
    public AbstrDATreeLikelihoodCore2(int nrOfStates, NodesStatesAndTree nodesStates, int nrOfCategories) {
    ...
    public int getNrOfSites() {
        return nodesStates.getSiteCount();
    }

    public int getNrOfTips() {
        return nodesStates.getTipsCount();
    }

    public int getNrOfInterNodes() {
        return nodesStates.getInternalNodeCount();
    }

    public int getNrOfNodes() {
        return nodesStates.getNodeCount();
    }
